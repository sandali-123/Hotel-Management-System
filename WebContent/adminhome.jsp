...
.bg{background:url('img/media/home/ri2.jpg') no-repeat;
  width:100%;
  height:100%;
}
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <h5>
                  This is the place where you can manage the user details . 
                </h5>
                <br>
              ...
              <div class="col-md-6 col-sm-12">
                    <img src="img/media/rum.jpg" style="width: 100%;height: 300px;">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 ">
                ...
                <br>
                <h5>
                  This is the place where you can manage the Room details . You can Add , Delete or Edit rooms in the hotel from here. As well as You can review the details of every room in the hotel.
                </h5>
                <br>
                <center><BUTTON class="btn btn-primary"><a href="allRooms.jsp" style="color: #fff;">Go to Room Management</a></BUTTON></center>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-1-lg ml-11">
        <div class="card" style="width:100%; height:300px;">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 col-sm-12">
                    <img src="img/media/rslm.jpg" style="width: 100%;height: 300px;">
              </div>
              <div class="col-md-6 col-sm-12">
                <br>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <center><BUTTON class="btn btn-primary"><a href="#" style="color: #fff;">Go to Supplier Management</a></BUTTON></center>
              </div>
              <div class="col-md-6 col-sm-12">
                    <img src="img/media/rsm.jpg" style="width: 100%;height: 300px;">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card" style="width:100%; height:300px;">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                    <img src="img/media/rim.jpg" style="width: 100%;height: 300px;">
              </div>
              <div class="col-md-6 col-sm-12">
                <br>
                ...
                <br>
                <center><BUTTON class="btn btn-primary"><a href="inventorydetails.jsp" style="color: #fff;">Go to Inventory Management</a></BUTTON></center>
              </div>
            </div>
          </div>
        </div>
