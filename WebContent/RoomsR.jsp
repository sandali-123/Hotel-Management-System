...
.card-sm{
box-shadow: 8px 8px 8px 8px rgba(.2,.2,.2,.2);
...
<div class="wrapper" style="background-image: url('img/media/beu.jpg');background-repeat:no-repeat;">
	<div class="sidebar">
    ...
    <br>
		<ul>
			<li><a href="Receptionist.jsp"><i class="fa fa-home"></i> Home</a></li>
			
			<li><a href="RoomsR.jsp"><i class="fa fa-bed" style="font-size:20px"></i>&nbsp  Room Reservation</a></li>
			<li><a href="EventsR.jsp"><i class="material-icons" style="font-size:20px">&#xe7f1;</i> &nbsp Hall Reservation</a></li>
	...
	<div class="row justify-content-center">
                        <!-- <div class="col-12 col-md-10 col-lg-8"> -->
                            <form class="card card-sm" method = "post" action="searchRecep.jsp">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
        ...
        <%
			try{
				...
				String sql ="select * from room_reservation group by roomReservationId";    
