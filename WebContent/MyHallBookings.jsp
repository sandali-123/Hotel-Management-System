    ...
    <br>
		...
		<div class="dropdown">
			...
			<li><a href="HallBooking.jsp"><i class="material-icons">&#xe7f1;</i>Event Reservation</a></li>
			 <li><a href="checkHallAvailability.jsp"><i class="fa fa-bed"></i>Room Reservation</a></li>
		  ...
		  <tr>
		   ...
		   <%
			try{
				...
				String sql ="select * from event where customername ='"+customername+"' AND eventdate ='"+eventdate+"'";
