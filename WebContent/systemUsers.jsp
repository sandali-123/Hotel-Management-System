...
<%@page import="com.Sewwandi.Util.*"%>
<%@page import="com.Sewwandi.Bean.*"%>
<%@page import="com.Sewwandi.Controller.*"%>
...
<div class="wrapper">
 ...
 <!--    <ul>
      ...
      <li><a href="inventorydetails.jsp"><i class="fa fa-address-card"></i>Equipment details</a></li>
      <li><a href="inventoryadd.jsp"><i class="fa fa-download"></i>Add new equipment</a></li>
      <li><a href="inventoryupdateandremove.jsp"><i class="fa fa-wrench"></i>Update or Remove equipments</a></li>
      <li><a href="inventoryupdatelist.jsp"><i class="fa fa-wrench"></i>Equipment Update List</a></li>
      <li><a href="inventoryremovelist.jsp"><i class="fa fa-wrench"></i>Equipment Remove List</a></li>
    </ul>
 -->
