          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <h5>
                 "Decide on the perfect wedding hall with your personal neccessities and preferances in mind for the grand event of your life in the atmosphere of a banquet hall."
                </h5>
                <br>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <br>
                <center><BUTTON class="btn btn-primary"><a href="menuOrder.jsp" style="color: #fff;">Go to Foods</a></BUTTON></center>
              </div>
            </div>
          </div>
        </div>
