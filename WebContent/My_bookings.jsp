    ...
    <div id="table" class="table-editable">
     ...
     <%
			try{
				...
				String sql ="select * from room_reservation where cName ='"+cName+"' AND checkIn ='"+checkIn+"' ";    
          ...
          <tr>
            ...
            <td class="pt-3-half" ><%=resultSet.getString("arrivalTime") %></td>
            ...
            <td>
              <span class="table-remove"><a
                  class="btn btn-success" name="updateBook" href="MyBkEdit.jsp?roomReservationId=<%= resultSet.getString("roomReservationId") %>" style="color: rgb(255, 255, 255);"><i class='fas fa-user-edit'></i>Edit </a></span>
