...
<body>
 ...
 <!--    <a href="#">Register</a> -->
	...
	<center>
		<h1>
			<img src="img/bad.jpg" width="100px" height="100px"> HOTEL
			SEWWANDI & WEDDING CENTER <img src="img/bad.jpg" width="100px"
				height="100px">
		</h1>
	</center>
	<br>
	...
	<div class="wrapper">
		<div class="sidebar">
			...
			<center>
				<img src="img/bad.jpg" width="100px" height="100px">
			</center>
			<br>
			<ul>
				<li><a href="customerloghome.jsp"><i class="fa fa-home"></i>Home</a></li>
				<div class="dropdown">
					<li><a href="#"><i class="fa fa-edit"><button
									class="dropbtn"></button></i>My Bookings
							</button></a></li>
					<div class="dropdown-content">
						<a href="selectbooking.jsp">My Events</a> 
						<a href="selectMyRBookings.jsp">My Room Bookings</a>
					</div>
				</div>
				<li><a href="checkHallAvailability.jsp"><i
						class="material-icons">&#xe7f1;</i>Event Reservation</a></li>
				<li><a href="Check_Availability.jsp"><i class="fa fa-bed"></i>Room Reservation</a></li>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						...
						<div class="panel-body">
							<form action="AddEventServlet" method="POST" onsubmit="return validate()"
								...
								<div class="form-group">
									<label for="hallno">Hall no</label> <input type="number"
										class="form-control" pattern="numbers" id="hallno"
										name="hallno" min="1" placeholder="" />
								</div>
								...
								<div class="form-group">
									<label for="eventtime">Event Time</label> <input type="time"
										class="form-control" id="eventtime" name="eventtime"
										placeholder="Enter event time">
								</div>

								<div class="form-group">
									<br> <label for="eventtype">Event type</label> <select
										size="0" class="form-control" id="eventtype" name="eventtype"
								...
								<div class="form-group">
									...
									<textarea class="form-control"
										style="width: 100%; height: 100px;" id="eventdescription"
										name="eventdescription"
										placeholder="Enter a small description"></textarea>
								</div>

								<div class="form-group">
									<label for="numberofguests">Number of guests</label> <input
										type="number" class="form-control" pattern="numbers"
										id="numberofguests" name="numberofguests" min="1"
										placeholder="Enter the number of guests" />
								</div>

								<div class="form-group">
									<br> <label for="photographer">Photographer</label> <select
										size="0" class="form-control" id="photographer"
										name="photographer" placeholder="Select a photographer">
										<option value="#">--Select a photographer--</option>
										<option value="none">none</option>
										<option value="Thiloka">Thiloka(0772904562) LKR
											20,000</option>
										<option value="Lakindu">Lakindu Sandeep(0771809234)
											LKR 35,000</option>
										<option value="Madusanka">Madusanka
											Herath(0713343342)LKR 30,000</option>
									</select>
								</div>

								<div class="form-group">
									<br> <label for="decorator">Decorator</label> <select
										size="0" class="form-control" id="decorator" name="decorator"
										placeholder="Select a decorator">
										<option value="#">--Select a decorator--</option>
										<option value="none">none</option>
										<option value="Kasun">Kasun (Wanamal ) LKR 50,000</option>
										<option value="Dilhara">Dilhara (Lassana Flora) LKR
											35,000</option>
										<option value="Kapila">Kapila (Araliya Flora ) LKR
											25,000</option>
									</select>
								</div>
								<div class="form-group">
									<br> <label for="makeupartist">Makeup Artist</label> <select
										size="0" class="form-control" id="makeupartist"
										name="makeupartist" placeholder="Select a makeup artist">
										...
										<option value="Nihal">Nihal (The flower bride)
											(0718125074) LKR25,000</option>
									</select>
								</div>
								<br> <input type="submit" class="btn btn-primary"
									value="submit" style="width: 30%; text-align: center;" />
