...
<form  method="post" action="UpdateBkServlet" onsubmit="return validateEventForm()" >
  <div class="container">
...
<input type="text" class="form-control" id="roomReservationId"  name="roomReservationId" value="<% out.print(roomReservationId); %>" hidden>
   ...
   <input type="date" class="form-control"  id="checkIn" name="checkIn" placeholder="Enter checkIn date" value="<%=resultSet.getString("checkIn") %>"required>
    ...
    <input type="text"  class="form-control" id="roomType" name="roomType"  value="<%=resultSet.getString("roomType") %>">
...
<!--  <option value="Non-AC Double Room">Non-AC Double Room</option>
    ...
    <hr>
    <button type="submit"  name = "updateBk" class="btn btn-success"  id="submit"  onclick="return valEdit() ;">Update</button>
  </div>
