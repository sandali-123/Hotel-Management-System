...
.btn-success{
		box-shadow: 3px 3px 3px 3px rgba(.2,.2,.2,.2);
...
<body style="background-image: url('img/media/report.jpeg');background-repeat:no-repeat;">
...
<div class="wrapper">
    ...
    <br>
		<ul>
			...
			<li><a href="EventsM.jsp"><i class="material-icons" style="font-size:20px">&#xe7f1;</i> &nbsp Hall Reservation</a></li>
 ...
 <!-- 
	...
	<!-- End of the search bar-->
	  <form action="reportPDF.jsp" method="post">
	   &nbsp &nbsp &nbsp &nbsp  &nbsp<button type="submit" class="btn btn-success"  href="reportPDF.jsp" ><i class="fa fa-file-pdf-o"></i> &nbsp  GENERATE PDF </button> 
	</form>
	<br>
<br>
 <!---------------------------------------------------------------------------------------------------------------------------------------------------------------------
