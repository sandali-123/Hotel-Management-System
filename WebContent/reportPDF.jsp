...
.bg{background-color:url('img/i2.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<body><div class="container p-3 my-3 border ">
<!-- <body>
...
<div class="wrapper">
 ...
 <!-- 
	...
	<br>
		...
		<br><center><h4>Report</h4></center><hr>
	   &nbsp &nbsp &nbsp &nbsp  &nbsp<button class="submit" onclick="window.print()"> &nbsp Print report  </button> 
  ...
  <div class="card-body">
    <div id="table" class="table-editable">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
		...
		</table></div></div></div></div><br><br><br><br><br>
...
</div></div><b><hr>Printed on : <%= (new java.util.Date()).toLocaleString()%></b><br> Hotel "Sewwandi",192,Galaluwa,
