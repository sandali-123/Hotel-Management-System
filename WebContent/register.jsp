...
<div class="header">
  <div class="header-right">
    ...
    <!-- <a href="#">Logout</a> -->
        ...
        <br>
        <center><h1><img src="img/media/rbad.jpg" width="100px" height="100px"> HOTEL SEWWANDI & WEDDING CENTER <img src="img/media/rbad.jpg" width="100px" height="100px"></h1></center>
    <br>
...
<div class="wrapper" >
  <!-- <div class="sidebar"> -->
    ...
    <center><img src="img/media/rbad.jpg" width="100px" height="100px" ></center>
    <br>
    <ul>
      <li><a href="register.jsp"><i class="fa fa-home"></i>View Profile</a></li>
      <li><a href="register.jsp"><i class="fa fa-address-card"></i>Delete My Account</a></li>
    </ul> -->

  </div>
  <div class="main_content" style="background-image: url('img/media/ri2.jpg');background-repeat:no-repeat;">
  ...
  <img src="images/3.jpg" style="width: 100%; height:150px;">
