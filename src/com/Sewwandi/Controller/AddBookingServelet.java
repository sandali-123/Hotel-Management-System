...
public class AddBookingServelet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("addBook") != null) {
			...
			response.sendRedirect("http://localhost:8080/Hotel_SEWWANDI/Booking_details.jsp");
		...
		// edit
		  ...
		  response.sendRedirect( "http://localhost:8080/Hotel_SEWWANDI/Check_Availability.jsp");
